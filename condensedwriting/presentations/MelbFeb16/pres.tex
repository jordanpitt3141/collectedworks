...
\begin{frame}{}
\begin{figure}
\includegraphics[width=9cm]{../pictures/smoothdambreak/dxto0/1diffmdx/paperpics/o3/6/nb3ne10/1-figure0.pdf}
\end{figure}
\end{frame}
...
\begin{frame}{}
\begin{figure}
\includegraphics[width=9cm]{../pictures/smoothdambreak/dxto0/1diffmdx/paperpics/o3/9/nb3ne10/1-figure0.pdf}
\end{figure}
\end{frame}
