...
sdirbase = "../../../../../data/postprocessing/RealLongTime/o3/9/all/"
...
for l in range(len(ylims)):    
    ...
    for timefix in timefixes:
        ...
        xbeg = int((cxlim[0] + 900 + x2)/dx) -1
        xend = int((cxlim[1] + 900 + x2)/dx) + 1
