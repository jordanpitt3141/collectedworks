...
#diffs = [0.025,0.5,2.5,10.0]
diffs = [0.5,2.5,4.5,8.5,10.0]
wdirbase = "../../../../../data/raw/DBSWREVanew100s/o3/10/"
sdirbase = "../../../../../data/postprocessing/DBSWbacksingular/o3/10/"
...
for diff in diffs:
    ...
    xlims = [[0-1,1000+1],[200-1,1000+1],[400-1,700+1],[250-1,450+1],[550-1,650+1],[590-1,620+1]]
