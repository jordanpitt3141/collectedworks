...
for ip in range(len(wdirords)):
    for jp in diffws:
        ...
        #for l in range(1):
            ...
            sdir = "../../../../../../data/postprocessing/smoothdball/paperpics/" + wdirord + "/" +str(diffw)+ "/" + sdirend
            ...
            if(l==0):                
                ...
                + "xmin=300, \n xmax=700, \n ymin = 1.0, \n  ymax = 1.8,\n"\
                + "xlabel=$x$ ($m$), \n ylabel=$h$ ($m$)]"\
                + "\\addplot [blue] table {dx10diff"+ str(beta) +"h.dat}; \n"\
                + "\\addplot [green!80!black] table {dx9diff"+ str(beta) +"h.dat}; \n"\
                + "\\addplot [red] table {dx8diff"+ str(beta) +"h.dat}; \n"\
                + "\\addplot [cyan!70!white] table {dx7diff"+ str(beta) +"h.dat}; \n"\
                + "\\addplot [violet!70!white] table {dx6diff"+ str(beta) +"h.dat}; \n"\
                + "\\addplot [yellow!70!black] table {dx5diff"+ str(beta) +"h.dat};\n"\
                + "\\addplot [black] table {dx4diff"+ str(beta) +"h.dat};\n"\
