 ...
 extern void ufromGh(double *G, double *h,double *hbeg,double *hend,double *ubeg,double *uend, double r, double epsilon, double dx , int n, int nBC, double *ue);
 ...
 extern void evolve(double *G, double *h, double *u, double g, double r, double epsilon, double dx, double dt,int n, int nBC, double *nh, double *nG);
 extern void evolvewrap(double *Ga, double *ha, double *Gabeg, double *Gaend, double *habeg, double *haend, double *hmbeg, double *hmend, double *uebeg, double *ueend, double *umbeg, double *umend, int nfcBC, int nGsBC, double g, double r, double epsilon, double dx, double dt, int n, int nBCa, int nBCm);
 %} 
 extern void conc(double *a , double *b, double *c,int n,int m ,int k, double *d);
 extern double *mallocPy(int n);
 extern void writetomem(double *x, int i , double f);
